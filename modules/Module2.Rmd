...
In Terminal, navigate to the your scratch directory.
`cd /mnt/work/workbench/<username>/scratch/`

Create a new directory inside the scratch directory for your username:
`mkdir <username>`

Now go to the directory you just created:
`cd <username>`

See your current working directory (i.e. where you are right now):
`pwd`

The path should have the pattern `/mnt/work/workbench/<username>/scratch/<username>`.
...
Set your working directory in RStudio in the consoles tab:
`setwd('/mnt/work/workbench/<username>/scratch/<username>')`
